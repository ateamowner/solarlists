...
export async function generateMetadata({
  ...
  const description = `${site.name} hub for ${city.name}, ${city.stateAbbr}. Solar installation, TPO solar, and solar panels — each with its own page. Consults go to ${site.operator}.`;
  return {
    title,
    description,
