...
export default function AboutPage() {
  return (
    <article className="mx-auto w-full max-w-3xl px-4 py-10 sm:px-6">
      ...
      <h2 className="mt-10 font-heading text-2xl font-semibold">Disclosure</h2>
      ...
      <p className="mt-3 leading-7">
        Cite or omit. No invented savings, incentive dollar amounts, warranties,
        timelines, or traffic stats. No fake reviews, star ratings, or installer
        directories. Eligibility copy stays generic — homeowners researching
        solar — until a real map exists. The{" "}
