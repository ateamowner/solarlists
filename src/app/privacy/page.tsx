  ...
  return (
    <article className="mx-auto w-full max-w-3xl px-4 py-10 sm:px-6">
      ...
      <p className="mt-3 leading-7">
        ...
        timing, and privacy consent are required. SMS consent is optional and
        stays visible. Optional fields sit behind More details: name, home
        ownership, monthly electric bill range, roof age and type, and message.
